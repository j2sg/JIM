...
View::Management::ProductModel::ProductModel(QList<Model::Domain::Product> *products, QObject *parent)
...
bool View::Management::ProductModel::insertProduct(int k, const Model::Domain::Product &product)
{
...
bool View::Management::ProductModel::modifyProduct(int k, const Model::Domain::Product &product)
{
    if(k < 0  || k > _products -> size())
        return false;
